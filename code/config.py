...
__C.TRAIN.LOSS_FUNCTION = 'cross_entropy'
__C.TRAIN.FOCAL_LOSS_ALPHA = 0.25
__C.TRAIN.FOCAL_LOSS_GAMMA = 2.0
...
__C.TRAIN.RESUME_COMET_EXP_KEY = ""
...
__C.DATASET.INPUT_SPATIAL_SIZE = 84
__C.DATASET.UPSCALE_FACTOR_TRAIN = 1.4
